  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Cookies:', document.cookie);
       ...
       if (response.data) {
        const { username, userId } = response.data.user;
        navigate("/user", { state: { username, userId } });
        navigate("/view-status", { state: { username, userId } }); // Passing both username and userId
      }
